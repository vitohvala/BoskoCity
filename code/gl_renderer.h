...
{
    glCreateProgram_ptr = (PFNGLCREATEPROGRAMPROC)platform_load_glfunc("glCreateProgram");
    glDeleteTextures_ptr = (PFNGLDELETETEXTURESPROC)platform_load_glfunc("glDeleteTextures");
    glGenTextures_ptr = (PFNGLGENTEXTURESPROC)platform_load_glfunc("glGenTextures");
    glBindTexture_ptr = (PFNGLBINDTEXTUREPROC)platform_load_glfunc("glBindTexture");
    glDrawArrays_ptr = (PFNGLDRAWARRAYSPROC)platform_load_glfunc("glDrawArrays");
    glCreateShader_ptr = (PFNGLCREATESHADERPROC) platform_load_glfunc("glCreateShader");
    glGetUniformLocation_ptr = (PFNGLGETUNIFORMLOCATIONPROC) platform_load_glfunc("glGetUniformLocation");
    glUniform1f_ptr = (PFNGLUNIFORM1FPROC) platform_load_glfunc("glUniform1f");
    glUniform2fv_ptr = (PFNGLUNIFORM2FVPROC) platform_load_glfunc("glUniform2fv");
    glUniform3fv_ptr = (PFNGLUNIFORM3FVPROC) platform_load_glfunc("glUniform3fv");
    glUniform1i_ptr = (PFNGLUNIFORM1IPROC) platform_load_glfunc("glUniform1i");
    glUniformMatrix4fv_ptr = (PFNGLUNIFORMMATRIX4FVPROC) platform_load_glfunc("glUniformMatrix4fv");
    glVertexAttribDivisor_ptr = (PFNGLVERTEXATTRIBDIVISORPROC) platform_load_glfunc("glVertexAttribDivisor");
    glActiveTexture_ptr = (PFNGLACTIVETEXTUREPROC) platform_load_glfunc("glActiveTexture");
    glBufferSubData_ptr = (PFNGLBUFFERSUBDATAPROC) platform_load_glfunc("glBufferSubData");
    glDrawArraysInstanced_ptr = (PFNGLDRAWARRAYSINSTANCEDPROC) platform_load_glfunc("glDrawArraysInstanced");
    glBindFramebuffer_ptr = (PFNGLBINDFRAMEBUFFERPROC) platform_load_glfunc("glBindFramebuffer");
    glCheckFramebufferStatus_ptr = (PFNGLCHECKFRAMEBUFFERSTATUSPROC) platform_load_glfunc("glCheckFramebufferStatus");
    glGenFramebuffers_ptr = (PFNGLGENFRAMEBUFFERSPROC) platform_load_glfunc("glGenFramebuffers");
    glFramebufferTexture2D_ptr = (PFNGLFRAMEBUFFERTEXTURE2DPROC) platform_load_glfunc("glFramebufferTexture2D");
    glDrawBuffers_ptr = (PFNGLDRAWBUFFERSPROC) platform_load_glfunc("glDrawBuffers");
    glDeleteFramebuffers_ptr = (PFNGLDELETEFRAMEBUFFERSPROC) platform_load_glfunc("glDeleteFramebuffers");
    glBlendFunci_ptr = (PFNGLBLENDFUNCIPROC) platform_load_glfunc("glBlendFunci");
    glBlendEquation_ptr = (PFNGLBLENDEQUATIONPROC) platform_load_glfunc("glBlendEquation");
    glClearBufferfv_ptr = (PFNGLCLEARBUFFERFVPROC) platform_load_glfunc("glClearBufferfv");
    glShaderSource_ptr = (PFNGLSHADERSOURCEPROC) platform_load_glfunc("glShaderSource");
    glCompileShader_ptr = (PFNGLCOMPILESHADERPROC) platform_load_glfunc("glCompileShader");
    glGetShaderiv_ptr = (PFNGLGETSHADERIVPROC) platform_load_glfunc("glGetShaderiv");
    glGetShaderInfoLog_ptr = (PFNGLGETSHADERINFOLOGPROC) platform_load_glfunc("glGetShaderInfoLog");
    glAttachShader_ptr = (PFNGLATTACHSHADERPROC) platform_load_glfunc("glAttachShader");
    glLinkProgram_ptr = (PFNGLLINKPROGRAMPROC) platform_load_glfunc("glLinkProgram");
    glValidateProgram_ptr = (PFNGLVALIDATEPROGRAMPROC) platform_load_glfunc("glValidateProgram");
    glGetProgramiv_ptr = (PFNGLGETPROGRAMIVPROC) platform_load_glfunc("glGetProgramiv");
    glGetProgramInfoLog_ptr = (PFNGLGETPROGRAMINFOLOGPROC) platform_load_glfunc("glGetProgramInfoLog");
    glGenBuffers_ptr = (PFNGLGENBUFFERSPROC) platform_load_glfunc("glGenBuffers");
    glGenVertexArrays_ptr = (PFNGLGENVERTEXARRAYSPROC) platform_load_glfunc("glGenVertexArrays");
    glGetAttribLocation_ptr = (PFNGLGETATTRIBLOCATIONPROC) platform_load_glfunc("glGetAttribLocation");
    glBindVertexArray_ptr = (PFNGLBINDVERTEXARRAYPROC) platform_load_glfunc("glBindVertexArray");
    glEnableVertexAttribArray_ptr = (PFNGLENABLEVERTEXATTRIBARRAYPROC) platform_load_glfunc("glEnableVertexAttribArray");
    glVertexAttribPointer_ptr = (PFNGLVERTEXATTRIBPOINTERPROC) platform_load_glfunc("glVertexAttribPointer");
    glBindBuffer_ptr = (PFNGLBINDBUFFERPROC) platform_load_glfunc("glBindBuffer");
    glBindBufferBase_ptr = (PFNGLBINDBUFFERBASEPROC) platform_load_glfunc("glBindBufferBase");
    glBufferData_ptr = (PFNGLBUFFERDATAPROC) platform_load_glfunc("glBufferData");
    glGetVertexAttribPointerv_ptr = (PFNGLGETVERTEXATTRIBPOINTERVPROC) platform_load_glfunc("glGetVertexAttribPointerv");
    glUseProgram_ptr = (PFNGLUSEPROGRAMPROC) platform_load_glfunc("glUseProgram");
    glDeleteVertexArrays_ptr = (PFNGLDELETEVERTEXARRAYSPROC) platform_load_glfunc("glDeleteVertexArrays");
    glDeleteBuffers_ptr = (PFNGLDELETEBUFFERSPROC) platform_load_glfunc("glDeleteBuffers");
    glDeleteProgram_ptr = (PFNGLDELETEPROGRAMPROC) platform_load_glfunc("glDeleteProgram");
    glDetachShader_ptr = (PFNGLDETACHSHADERPROC) platform_load_glfunc("glDetachShader");
    glDeleteShader_ptr = (PFNGLDELETESHADERPROC) platform_load_glfunc("glDeleteShader");
    glDrawElementsInstanced_ptr = (PFNGLDRAWELEMENTSINSTANCEDPROC) platform_load_glfunc("glDrawElementsInstanced");
    glGenerateMipmap_ptr = (PFNGLGENERATEMIPMAPPROC) platform_load_glfunc("glGenerateMipmap");
    glDebugMessageCallback_ptr = (PFNGLDEBUGMESSAGECALLBACKPROC)platform_load_glfunc("glDebugMessageCallback");
    //glGetString_ptr = (PFNGLGETSTRINGPROC)platform_load_glfunc("glGetString");
}
