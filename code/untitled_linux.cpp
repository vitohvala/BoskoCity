...
function void
console_writef(usize level, const char *fmt, ...)
{
    char buffer[2048];
    va_list args;
...
function void
console_writef_error(const char *fmt, ...)
{
    char buffer[2048];
    va_list args;
...
function X11Window
linux_create_window(int width, int height, const char *name)
{
...
function FullPath
linux_find_fullpath(String8 *exe_dir, const char *filename1, const char *filename2)
{
